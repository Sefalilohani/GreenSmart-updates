...
QUERY_ID          = 2069
PER_QUERY_API_KEY = "P2tTvJPyV0O8gOYfP5NHsGKDJucX7pzpoFxTPWfH"
REDASH_REPORT_URL = f"{REDASH_URL}/queries/{QUERY_ID}#2896"
...
def build_message(rows):
    ...
    message = (
        f"*Update on Green Smart Mobility client In Progress checks*\n\n"
        f"{table}\n\n"
        f"{bullets}\n\n"
